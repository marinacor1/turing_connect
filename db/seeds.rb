class Seed
  ...
  def create_admin #marina, mike, marissa, city and state are validated.
    ...
    users = User.create!([
      {github_id: '14285122', role: 1, street_address: "1510 Blake Street", city: "Denver", state: "CO"},
      {github_id: '3011748', role: 1, street_address: "1510 Blake Street", city: "Denver", state: "CO"},
