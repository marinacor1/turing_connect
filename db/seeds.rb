...
users = User.create!([{cohort: "1406", state: "AK"},
   {cohort: "1407", state: "AL"},
   {cohort: "1409", state: "AR"},
   {cohort: "1410", state: "AZ"},
   {cohort: "1412", state: "CA"},
   {cohort: "1502", state: "CO"},
   {cohort: "1503", state: "CT"},
   {cohort: "1505", state: "DC"},
   {cohort: "1507", state: "DE"},
   {cohort: "1510", state: "FL"},
   {cohort: "1511", state: "GA"},
   {cohort: "1602", state: "HI"},
   {cohort: "1603", state: "IA"},
   {cohort: "1605", state: "ID"},
   {cohort: "1406", state: "IL"},
   {cohort: "1406", state: "IN"},
   {cohort: "1406", state: "KS"},
   {cohort: "1406", state: "KY"},
   {cohort: "1406", state: "LA"},
   {cohort: "1406", state: "MA"},
   {cohort: "1406", state: "MD"},
   {cohort: "1406", state: "ME"},
   {cohort: "1406", state: "MI"},
   {cohort: "1406", state: "MN"},
   {cohort: "1406", state: "MO"},
   {cohort: "1406", state: "MS"},
   {cohort: "1406", state: "MT"},
   {cohort: "1406", state: "NC"},
   {cohort: "1406", state: "ND"},
   {cohort: "1406", state: "NE"},
   {cohort: "1406", state: "NH"},
   {cohort: "1406", state: "NJ"},
   {cohort: "1406", state: "NM"},
   {cohort: "1406", state: "NV"},
   {cohort: "1406", state: "NY"},
   {cohort: "1406", state: "OH"},
   {cohort: "1406", state: "OK"},
   {cohort: "1406", state: "OR"},
   {cohort: "1406", state: "PA"},
   {cohort: "1406", state: "PR"},
   {cohort: "1406", state: "RI"},
   {cohort: "1406", state: "SC"},
   {cohort: "1406", state: "SD"},
   {cohort: "1406", state: "TN"},
   {cohort: "1406", state: "TX"},
   {cohort: "1406", state: "UT"},
   {cohort: "1406", state: "VA"},
   {cohort: "1406", state: "VT"},
